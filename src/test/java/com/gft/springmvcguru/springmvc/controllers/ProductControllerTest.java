...
public class ProductControllerTest {
    ...
    public void testList() throws Exception{
        ...
        //cuando especificamos Mockito interacción, decimos stub para retornar una lista de productos
        when(productService.listAll()).thenReturn((List) products); //necesitamos to stript genericos para mentener Mockito feliz.
    ...
    public void testShow() throws Exception{
        ...
        //cuando especificamos Mockito interacción, decimos stub para retornar una lista de productos
        when(productService.getById(1)).thenReturn(new Product()); //necesitamos to stript genericos para mentener Mockito feliz.
